namespace CustomDataStructures
{
    ...
    public class CustomLinkedHashMap<TKey, TValue> : IEnumerable<KeyValue<TKey, TValue>>
    {
        ...
        private LinkedList<KeyValue<TKey, TValue>> entryOrder; 

        public CustomLinkedHashMap(int capacity = DefaultCapacity)
        {
            this.slots = new LinkedList<KeyValue<TKey, TValue>>[capacity];
            this.Count = 0;
            this.entryOrder = new LinkedList<KeyValue<TKey, TValue>>();
        }
        ...
        public void Add(TKey key, TValue value)
        {
            ...
            this.entryOrder.AddLast(newElement);
            this.Count++;
        ...
        public bool Remove(TKey key)
        {
            ...
            this.entryOrder.Remove(elementToRemove);
        ...
        {
            return this.entryOrder.GetEnumerator();
        }
        ...
        private void Grow()
        {
            var newHashTable = new CustomLinkedHashMap<TKey, TValue>(2 * this.Capacity);
            ...
            this.entryOrder = newHashTable.entryOrder;
        }
