namespace CustomDataStructuresTests
{
    ...
    {
        [TestMethod]
        public void Add_EmptyCustomHashMap_NoDuplicates_ShouldAddElement()
        {
            // Arrange
        ...
        public void Add_EmptyCustomHashMap_Duplicates_ShouldThrowException()
        {
            // Arrange
            var hashMap = new CustomHashMap<string, string>();
        ...
        {
            // Arrange
            var hashMap = new CustomHashMap<string, int>(1);
        ...
        {
            // Arrange
            var hashMap = new CustomHashMap<int, string>();
        ...
        {
            // Arrange
            var hashMap = new CustomHashMap<string, int>(2);
        ...
        {
            // Arrange
            var hashMap = new CustomHashMap<string, DateTime>();
            var name = "Maria";
        ...
        {
            // Arrange
            var hashMap = new CustomHashMap<DateTime, string>();
            var date = new DateTime(1995, 7, 18);
        ...
        {
            // Arrange
            var hashMap = new CustomHashMap<string, double>();
