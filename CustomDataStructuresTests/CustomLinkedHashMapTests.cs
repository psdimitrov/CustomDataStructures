namespace CustomDataStructuresTests
{
    ...
    {
        [TestMethod]
        public void Add_EmptyCustomLinkedHashMap_NoDuplicates_ShouldAddElement()
        {
            // Arrange
            var hashMap = new CustomLinkedHashMap<string, int>();
        ...
        public void Add_EmptyCustomLinkedHashMap_Duplicates_ShouldThrowException()
        {
            // Arrange
            var hashMap = new CustomLinkedHashMap<string, string>();
        ...
        {
            // Arrange
            var hashMap = new CustomLinkedHashMap<string, int>(1);
        ...
        {
            // Arrange
            var hashMap = new CustomLinkedHashMap<int, string>();
        ...
        {
            // Arrange
            var hashMap = new CustomLinkedHashMap<string, int>(2);
        ...
        {
            // Arrange
            var hashMap = new CustomLinkedHashMap<string, DateTime>();
            var name = "Maria";
        ...
        {
            // Arrange
            var hashMap = new CustomLinkedHashMap<DateTime, string>();
            var date = new DateTime(1995, 7, 18);
        ...
        {
            // Arrange
            var hashMap = new CustomLinkedHashMap<string, double>();
